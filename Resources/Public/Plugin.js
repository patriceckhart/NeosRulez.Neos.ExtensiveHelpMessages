...
var ExtensiveHelpMessage = function (_React$Component) {
    _inherits(ExtensiveHelpMessage, _React$Component);

    function ExtensiveHelpMessage() {
        _classCallCheck(this, ExtensiveHelpMessage);

        return _possibleConstructorReturn(this, (ExtensiveHelpMessage.__proto__ || Object.getPrototypeOf(ExtensiveHelpMessage)).apply(this, arguments));
    }

    _createClass(ExtensiveHelpMessage, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: _styles2.default.extensiveHelpMessageWrapper },
                _react2.default.createElement(
                    'div',
                    { className: _styles2.default.extensiveHelpMessage, style: style },
                    this.props.helpThumbnail && _react2.default.createElement(
                        'div',
                        { className: _styles2.default.extensiveHelpMessageImage },
                        _react2.default.createElement('img', { src: '/_Resources/Static/Packages/' + this.props.helpThumbnail })
                    ),
                    _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: this.props.helpMessage } })
                )
            );
        }
    }]);

    return ExtensiveHelpMessage;
}(_react2.default.Component);

exports.default = ExtensiveHelpMessage;
...
var _ExtensiveHelpMessage = __webpack_require__(/*! ./ExtensiveHelpMessage */ "./src/ExtensiveHelpMessage.js");

var _ExtensiveHelpMessage2 = _interopRequireDefault(_ExtensiveHelpMessage);
...
(0, _neosUiExtensibility2.default)('NeosRulez.Neos.ExtensiveHelpMessages:HelpMessages', {}, function (globalRegistry, _ref) {
    var frontendConfiguration = _ref.frontendConfiguration;

    var style = frontendConfiguration['NeosRulez.Neos.ExtensiveHelpMessages:Style'];
    var editorsRegistry = globalRegistry.get('inspector').get('editors');
    var editorsRegistryList = editorsRegistry._registry;
    for (var i in editorsRegistryList) {
        var editorKey = editorsRegistryList[i].key;
        var defaultEditorDefinition = editorsRegistry.get(editorKey);
        editorsRegistry.set(editorKey, _extends({}, defaultEditorDefinition, {
            component: editorWrapper(defaultEditorDefinition.component, style)
        }));
    }
});

function editorWrapper(DefaultEditor, style) {
    var _class, _temp;

    return _temp = _class = function (_PureComponent) {
        _inherits(EditorWrapper, _PureComponent);
        ...
        _createClass(EditorWrapper, [{
            ...
            value: function render() {
                var _props = this.props,
                    ...
                    helpThumbnail = _props.helpThumbnail;


                return _react2.default.createElement(
                    'div',
                    { className: _styles2.default.inspectorPropWrapper },
                    helpMessage && _react2.default.createElement(
                        _react.Fragment,
                        null,
                        _react2.default.createElement(
                            'button',
                            { type: 'button', className: this.state.isToggleOn ? _styles2.default.extensiveHelpMessageButtonActive : _styles2.default.extensiveHelpMessageButton, onClick: this.handleClick },
                            _react2.default.createElement(_reactUiComponents.Icon, { icon: 'fas fa-question-circle' })
                        ),
                        _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: '.style__envelope__tooltipButton___2pIzZ { display:none; }' } })
                    ),
                    _react2.default.createElement(DefaultEditor, this.props),
                    helpMessage && this.state.isToggleOn && _react2.default.createElement(_ExtensiveHelpMessage2.default, { helpMessage: helpMessage, helpThumbnail: helpThumbnail, style: style })
                );
            }
        }]);
        ...
        helpMessage: _propTypes2.default.object,
        helpThumbnail: _propTypes2.default.object
    }, _temp;
}
...
module.exports = {"inspectorPropWrapper":"styles__inspectorPropWrapper___3REb2","extensiveHelpMessageWrapper":"styles__extensiveHelpMessageWrapper___1GRyN","extensiveHelpMessage":"styles__extensiveHelpMessage___3jDOo","extensiveHelpMessageImage":"styles__extensiveHelpMessageImage___2oV_U","extensiveHelpMessageButton":"styles__extensiveHelpMessageButton___ftLq-","extensiveHelpMessageButtonActive":"styles__extensiveHelpMessageButtonActive___1mI-a"};
